...
import tuan.dao.BookDAO;
import tuan.dto.BookDTO;
...
public class View extends javax.swing.JFrame {
    ...
    public View() {
        ...
        ckbForRent.setEnabled(true);
        cobPublisherYear.setEnabled(true);
        txtBookName.setEditable(true);
        txtPublisher.setEditable(true);
        txtSearchByName.setEditable(true);
                  
    }
        public void setnoEdit(){
        txtAuthor.setEditable(false);
        txtBookID.setEditable(false);
        ckbForRent.setEnabled(false);
        cobPublisherYear.setEnabled(false);
